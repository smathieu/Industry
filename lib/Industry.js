...
(function() {
  ...
  IndustryModel = (function() {
    ...
    IndustryModel.prototype.create = function() {
      var argument, data, key, traits, val, _i, _len,
        _this = this;
      data = {};
      traits = [];
      ...
      new TraitSelection(this).each(traits, function(trait, d) {
        return data = $.extend({}, data, trait.call(_this, d));
      });
      for (key in data) {
        val = data[key];
  ...
  IndustryCollection = (function(_super) {
    ...
    IndustryCollection.prototype.create = function() {
      var argument, cache, collection, count, data, i, model, traits, _i, _j, _klass, _len;
      count = 5;
      data = {};
      traits = [];
      cache = false;
      ...
      _klass = this._klass;
      this._klass = false;
      data = IndustryCollection.__super__.create.call(this, data);
      this._klass = _klass;
      collection = [];
      ...
      if (typeof model !== 'undefined' && model !== null) {
        if (count > 0) {
          for (i = _j = 1; 1 <= count ? _j <= count : _j >= count; i = 1 <= count ? ++_j : --_j) {
            ...
            collection.push(model.create.apply(model, __slice.call(traits).concat([data])));
          }
        }
      } else {
  ...
  TraitSelection = (function() {
    ...
    TraitSelection.prototype.each = function(traits, callback) {
      var name, options, trait, _i, _len, _results;
      _results = [];
